                ...
                if($userid){
                    ...
                    if($res){
                        ...
                        $body = <<<EOF
                                    ...
                                    enlace: http://172.17.0.3:4200/set-your-password/$token
                    ...
                    }else echo json_encode(['status'=>500, 'message'=>'Hubo un error inesperado al insertar el token']);
                }else echo json_encode(['status'=>500, 'message'=>'Hubo un error inesperado al realizar el registro']);
