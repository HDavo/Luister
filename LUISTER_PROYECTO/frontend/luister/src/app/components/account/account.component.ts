...
export class AccountComponent {
  ...
  constructor( 
    ...
    route.params.subscribe((params: any)=>{
      if(params.section == 'profile' || params.section == 'following' || params.section == 'settings'){
  ...
  updateUserData(element:any){
    const target = element.parentNode.getElementsByClassName('userdata-input-field')[0];
